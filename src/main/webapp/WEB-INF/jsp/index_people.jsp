...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">${people.name}</strong>
                                    </span>
                                </span>
                        </a>
                    </div>
                    <div class="logo-element">${people.name}
                    </div>
                </li>
                ...
                <li>
                    <a href="#"><i class="fa fa-paste"></i> <span class="nav-label">社团</span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/com_record_people">查看社团</a>
                        </li>
                    </ul>
                </li>
                <li class="line dk"></li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="row J_mainContent" id="content-main">
            <iframe id="J_iframe" width="100%" height="100%" src="/com_record_people" frameborder="0" data-id="/stu_index" seamless></iframe>
        </div>
    </div>
    <!--右侧部分结束-->
</div>
