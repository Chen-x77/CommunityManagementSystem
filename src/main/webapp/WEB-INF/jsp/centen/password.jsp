...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" action="/centen_passwordFrom" id="passwordForm" name="passwordForm" method="post">
    ...
    <script type="text/javascript"  src="./js/centen_pwdmodify.js"></script>
