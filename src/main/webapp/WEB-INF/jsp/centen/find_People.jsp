					...
					<div class="row m-b-sm m-t-sm">
						...
						<div class="col-md-4" style="float: left;">
							<div class="input-group" >
								<form class="form-inline" action="/queryPeople_centen" method="get">
					...
					<div class="project-list row">
						<table class="table table-hover">
							...
							<c:forEach var="people" items="${peopleList}" varStatus="status">
								...
								<td>
									<a href="/ChaKanPeople_centen?peo_id=${people.id}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i>查看</a>
									<a href="/delPeople_centen?peopleId=${people.id}&peopleFlag=${people.flag}&comId=${people.com_id}" class="btn btn-primary btn-sm" > <i class="fa fa-remove"></i>删除</a>
								</td>
								</tr>
							</c:forEach>
							</tbody>
