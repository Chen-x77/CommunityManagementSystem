                    ...
                    <div class="project-list row">
                        <table class="table table-hover">
                            ...
                            <c:forEach var="activity" items="${activityList}" varStatus="status">
                                ...
                                <td>
                                    <a href="/ChaKanActivity_centen?activity_id=${activity.id}" class="btn btn-white btn-sm"><i class="fa fa-folder"></i>查看</a>
                                    <a href="/delActivity_centen?activity_id=${activity.id}" class="btn btn-white btn-sm"><i class="fa fa-folder"></i>删除</a>
                                </td>
                                </tr>
                            </c:forEach>
                            </tbody>
