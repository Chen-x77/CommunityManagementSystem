...
<div class="container" style="position: absolute; z-index: 10">
    ...
    <div class="card-wrap">
        ...
        <div class="card border-0 shadow card--welcome is-show" id="welcome">
            <div class="card-body">
                <h2 class="card-title">高校社团管理系统</h2>
                <p>助力高校社团管理</p>
                <div class="btn-wrap">
                    <a class="btn btn-lg btn-login1 js-btn" data-target="login1"style="margin: 5px;" onclick="$('img').onclick()">普通用户登录</a>
                    <a class="btn btn-lg btn-register js-btn" data-target="login2"style="margin: 5px;" onclick="$('img').onclick()">社团管理员登录</a>
                    <a class="btn btn-lg btn-login js-btn" data-target="login3"style="margin: 5px;" onclick="$('img').onclick()">系统管理员登录</a>

                    <a href="javascript:subToHX();">>点我注册</a>
                    <div>
                        <form id="myForm" action="/register" method="post"></form>
                    </div>
                    <script>
                        function subToHX(){
        ...
        <div class="card border-0 shadow card--welcome" id="login1">
            <div class="card-body">
                <h2 class="card-title">普通用户登录 </h2>
                <form id = "form1" action="/peoLogin" method="post">
        ...
        <div class="card border-0 shadow card--register" id="login2">
            <div class="card-body">
                <h2 class="card-title">社团管理员登录</h2>
                <form name = "form" action="/peoLogin" method="post" >
                    <div class="form-group">
                        <input class="form-control"  name="userName" type="text" placeholder="请输入用户名" required="required">
                    </div>
                    <div class="form-group">
        ...
        <div class="card border-0 shadow card--login" id="login3">
            <div class="card-body">
                <h2 class="card-title">系统管理员登录</h2>
