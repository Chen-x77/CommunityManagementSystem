		                    ...
		                    <div class="row m-b-sm m-t-sm">
								...
								<div class="col-md-4" style="float: left;">
									<div class="input-group" >
										<form class="form-inline" action="/queryCommFrom" method="get">
		                    ...
		                    <div class="project-list row">
		                        <table class="table table-hover">
		                            ...
		                            <tbody>
											...
											<td>
											    <a href="/setComm?commId=${comm.id}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i>修改</a>
												<a href="/delComm?commId=${comm.id}" class="btn btn-primary btn-sm" > <i class="fa fa-remove"></i>删除</a>
											</td>
		                                </tr>
											</c:forEach>
		                            </tbody>
