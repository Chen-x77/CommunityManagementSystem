                        ...
                        <div class="row row-sm text-center">
                            ...
                            <div class="col-xs-6">
                                <div class="panel padder-v item">
                                    ...
                                    <span class="text-muted text-xs">本社会员数</span>
                            ...
                            <div class="col-xs-6">
                                <div class="panel padder-v item">
                                    <div class="h1 text-info font-thin h1">${applySum}</div>
                                    <span class="text-muted text-xs">入社请求数</span>
                                    <div class="top text-right w-full">
                                        <i class="fa fa-caret-down text-warning m-r-sm"></i>
                                    </div>
                                </div>
                                ...
                                <div class="row m-b-sm m-t-sm">
                                    ...
                                    <div class="col-md-4" style="float: left;">
                                        <div class="input-group" >
                                            <form class="form-inline" action="/queryCommActivityName_member" method="get">
